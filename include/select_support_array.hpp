...
class select_support_array {
public:
    select_support_array() : m_positions(0) {}

    select_support_array(bit_vector const& bv) : m_positions(0) {
        this->build(bv);
    }

    void swap(select_support_array& other) {
